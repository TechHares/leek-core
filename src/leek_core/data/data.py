...
from leek_core.models import LeekComponentConfig, InitDataPackage, DataType
from leek_core.utils import log_method, get_logger
from .base import ComponentManager, CTX
...
class DataManager(ComponentManager[DataSourceContext, DataSource, Dict[str, Any]]):
    ...
    def __init__(self, event_bus: EventBus, config: LeekComponentConfig[DataSourceContext, None], callback):
        """
        初始化数据源管理器。
