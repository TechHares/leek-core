...
from leek_core.info_fabricator import KLineFillFabricator
from leek_core.models.constants import TimeFrame, TradeInsType
...
class TestKLineFillProcessor(unittest.TestCase):
    ...
    def setUp(self):
        """初始化测试环境"""
        self.processor = KLineFillFabricator()
